...
# Reference implementations https://github.com/Eircx/Pytorch-ResNet
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):
        ...
        self.in_channels = 64
        #将其第一个卷积层的卷积核大小改为3x3,由此来适应CIFAR-10数据集
    ...
    def _make_layer(self, block, out_channels, num_blocks, stride):
        ...
        # have num_blocks - 1 sub-layer with stride = 1
...
def testResnet():
    resnet_18=resnet18()
    resnet_18.to(torch.device("cuda:0" if torch.cuda.is_available() else "cpu"))
