...
if __name__ == '__main__':
    ...
    #res18 = resnet18(sample_input_D = 64,sample_input_H=128,sample_input_W=128,num_seg_classes=10)
    res18 = resnet18(num_seg_classes=10)
    res18.to(torch.device("cuda:0" if torch.cuda.is_available() else "cpu"))
    summary(res18,(1,128,128,64))
    #test_graph()
